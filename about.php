...
<body>
  ...
  <div class="page-banner  bg-image" style="background-color: lightblue;">
  ...
  <div class="bg-light">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow ">
              ...
              <p><span>On</span>Doc Protection</p>
            </div>
          </div>
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow ">
    ...
    <center>
      <h2 class="title">FAQs</h2>
       ...
       <div class="faq">
        <div class="question">
          <h3> What is On-Doc ? </h3>

          
          <svg width="15" height="10"  viewbox="0 0 42 25">
            <path d="M3 3L21 21L39 3" stroke="white" stroke-width="7" strok-linecap="round"/>
          </svg>

        </div>
        <div class='answer'>
          <p> It is a webpage to help those in need of medical services electronically without one moving from their location to a medical center.
          </p>
        </div>
      </div>
      ...
      <div class="faq">
        ...
        <div class='answer'>
          <p>  Here one is able to keep in touch with your doctor or any medical officer on your health issues and (s)he is able to help you out.
          </p>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="owl-carousel wow " id="doctorSlideshow">
        <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. John Karanja</p>
        ...
        <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Ian Cris</p>
        ...
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="../assets/img/doctors/doc female.jpg" alt="">
              <div class="meta">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Winnie Munene</p>
        ...
        <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Peter Mutuota</p>
        ...
        <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Hellen Wambui</p>
